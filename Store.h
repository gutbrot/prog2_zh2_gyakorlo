...
public:
    ...
    void list(std::ostream& os) const { // kiírja az adatokat vesszővel elválasztva
        for (int i = 0; i < nVal; ++i) {
            os << (i > 0 ? ", " : "") << data[i]; // előd előtt nincs vessző
        }
        os << std::endl;
    }
...
// definiálták. Készítse el a hiányzó kívül definiált tagfüggvényeket úgy, hogy az osztály 
// használatakor ne lépjen fel memóriakezelési hibat. Működjön helyesen az alábbi kódrészlet:    
...
// Ahol szükséges, hogy mit készített el, tegye definiálttá a megfelelő makrót (törölje a //-t):
